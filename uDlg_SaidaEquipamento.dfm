inherited frmDlg_SaidaEquipamento: TfrmDlg_SaidaEquipamento
  ActiveControl = edtEquipamento
  Caption = 'Sa'#237'da de equipamento'
  ClientHeight = 302
  ClientWidth = 378
  ExplicitWidth = 386
  ExplicitHeight = 336
  ...
  inherited Panel2: TPanel
    ...
    object edtUnidade: TEditPesquisa
      ...
      AutoPesquisa = True
      AutoCompletar = True
      OnRegAchado = edtUnidadeRegAchado
      UsaBtnNovo = False
      UsaBtnEditar = False
      UsaDisplay = True
      LblTitulo.Left = 15
    ...
    object LabelDBEdit1: TLabelDBEdit
      ...
      Titulo.Width = 101
      Titulo.Height = 13
      Titulo.Caption = 'Contador contratado'
