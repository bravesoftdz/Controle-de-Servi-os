inherited frmDlg_ArvorePeca: TfrmDlg_ArvorePeca
  ...
  inherited Panel2: TPanel
    ...
    ExplicitWidth = 426
    ExplicitHeight = 263
    object edtMaterial: TEditPesquisa
      Left = 16
      Top = 32
      Width = 65
      Height = 21
      ...
      AutoPesquisa = True
      AutoCompletar = True
      OnRegAchado = edtMaterialRegAchado
      UsaBtnNovo = False
      UsaBtnEditar = False
      UsaDisplay = True
      LblTitulo.Left = 16
    ...
    object edtQtd: TLabelDBEdit
      Left = 320
      Top = 32
      Width = 73
      Height = 21
      DataField = 'QUANTIDADE'
      DataSource = frmCad_Equipamento.DataArvore
      TabOrder = 2
      Titulo.Left = 320
      Titulo.Top = 17
      Titulo.Width = 56
