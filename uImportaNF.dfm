inherited frmImportaDados: TfrmImportaDados
  ActiveControl = edtDataIni
  Caption = 'Importa notas fiscais do Empresa f'#225'cil'
  ClientHeight = 227
  ClientWidth = 396
  ExplicitWidth = 404
  ExplicitHeight = 261
  ...
  inherited Panel2: TPanel
    ...
    object edtCodMov: TLabeledEdit
      ...
      EditLabel.Width = 95
      EditLabel.Height = 13
      EditLabel.Caption = 'C'#243'd. Movimenta'#231#227'o'
      TabOrder = 4
    end
  end
  object ConexaoAds: TAdsConnection
    AdsServerTypes = [stADS_REMOTE, stADS_LOCAL]
    LoginPrompt = False
    Left = 224
    Top = 128
  end
  object Qry: TAdsQuery
    DatabaseName = 'ConexaoAds'
    SourceTableType = ttAdsCDX
    AdsConnection = ConexaoAds
    Left = 296
    Top = 128
    ParamData = <>
  end
  object QryItens: TAdsQuery
    DatabaseName = 'ConexaoAds'
    SourceTableType = ttAdsCDX
    AdsConnection = ConexaoAds
    Left = 352
